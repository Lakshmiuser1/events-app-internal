...
//        e.g https://github.com/Lakshmiuser1/events-app-internal.git might become https://github.com/MyName/external.git
// variables:
//      roidtc-april2022-u212
//      dockertest  //id of your global docker credentials in Jenkins https://www.google.com/search?q=add+docker+credentials+Jenkins&oq=add+docker+credentials+Jenkins
//      https://github.com/Lakshmiuser1/events-app-internal.git
//      lakshmid1
//      internal
//      cluster-1 
    ...
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/Lakshmiuser1/events-app-internal/internal.git'
        ...
        stage('Building image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials cluster-1 --zone us-central1-c --project roidtc-april2022-u212'
            }
        }     
         stage('update k8s') {
             agent {
